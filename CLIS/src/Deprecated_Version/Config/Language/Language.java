package Deprecated_Version.Config.Language;
...
public class Language
{
	...
	static
	{
		...
		captions.put( SETTING_TASK_LABSTREAMINGLAYER_TAB, new Caption( SETTING_TASK_LABSTREAMINGLAYER_TAB, defaultLanguage, "Lab Streaming Layer" ) );
		captions.put( SETTING_TASK_LABSTREAMINGLAYER_EVENT, new Caption( SETTING_TASK_LABSTREAMINGLAYER_EVENT, defaultLanguage, "Event" ) );
		captions.put( SETTING_TASK_LABSTREAMINGLAYER_MARK, new Caption( SETTING_TASK_LABSTREAMINGLAYER_MARK, defaultLanguage, "Mark" ) );
		captions.put( SETTING_TASK_LABSTREAMINGLAYER_FILE, new Caption( SETTING_TASK_LABSTREAMINGLAYER_FILE, defaultLanguage, "File name" ) );
		captions.put( SETTING_TASK_LABSTREAMINGLAYER_OUTPUT_FORMAT, new Caption( SETTING_TASK_LABSTREAMINGLAYER_OUTPUT_FORMAT, defaultLanguage, "Output file format" ) );
		captions.put( SETTING_TASK_LABSTREAMINGLAYER_REFRESH, new Caption( SETTING_TASK_LABSTREAMINGLAYER_REFRESH, defaultLanguage, "Refresh" ) );
	}
