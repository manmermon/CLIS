...
public class menuWindow_AboutApp extends JDialog
{
	...
	private final String sourceURL = "https://github.com/manmermon/CLIS";
	...
	private JPanel getJContentPaneAcercaDe()
	{
		if (this.jContentPaneAcercaDe == null)
		{
			...
			this.jLabelWeb.setText( Language.getCaption( Language.ABOUT_WEB_LABEL, ConfigApp.getProperty( ConfigApp.LANGUAGE ).toString() ) 
									+": " + this.url );
			...
			this.jLabelEmail.setText(Language.getCaption( Language.ABOUT_EMAIL_LABEL, ConfigApp.getProperty( ConfigApp.LANGUAGE ).toString() )
										+": " + this.authorEmail );
			...
			this.jLabelAutor.setText( Language.getCaption( Language.ABOUT_AUTHOR_LABEL, ConfigApp.getProperty( ConfigApp.LANGUAGE ).toString() ) 
										+": Manuel Merino Monge");
			
			this.jLabelSourceURL = new JLabel();
			this.jLabelSourceURL.setAlignmentX( Component.CENTER_ALIGNMENT );
			this.jLabelSourceURL.setText( Language.getCaption( Language.ABOUT_SOURCE_CODE_LABEL, ConfigApp.getProperty( ConfigApp.LANGUAGE ).toString() )
											+ " " + this.sourceURL );
	...
	private JTextArea getChkbxGPL()
	{
		if (this.jTextAreaGPL == null)
		{
			...
			txt = txt + "Software Registration in Andalusia Government in Seville (Spain). ";
			txt = txt + "Register Number: 201199901443345. Date: October 2011.\n\n";
			txt = txt + "CLIS is free software: you can redistribute it and/or modify ";
			...
			txt = txt + "CLIS is distributed in the hope that it will be useful, ";
			...
			txt = txt + "along with CLIS.  If not, see <http://www.gnu.org/licenses/>.";
